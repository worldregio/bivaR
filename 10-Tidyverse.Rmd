...
On récupère un tableau de données facile à exploiter.
...
On aboutit au même résultat mais l'écriture en dplyr est beaucoup plus concise et beaucoup plus élégante qu'en R-base.
